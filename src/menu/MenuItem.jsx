...
//--------------------------------STYLES--------------------------------------//
const windowWidth = window.innerWidth // 1920px on 1080p
const windowHeight = window.innerHeight // 1080px on 1080p

const columnWidth = (windowWidth - 4) / 2 // 958px on 1080p
